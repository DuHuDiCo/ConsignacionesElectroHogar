...
public class DaoObservacion {
    ...
    private static final String SQL_DELETE_OBSERVACIONTEMPORALBYID = "DELETE FROM observaciones_temporal WHERE idObservaciones = ?";
    private static final String SQL_DELETE_OBSERVACIONTEMPORALBYIDUSUARIO = "DELETE FROM observaciones_temporal WHERE id_usuario = ?";
    ...
    public int observacionTemporal(String observacion, int id_usuario, int id_consignacion) throws ClassNotFoundException, SQLException {
        Connection con = null;
        PreparedStatement stmt = null;
    ...
    public int eliminarObserTempByIdUsuario(int id_usuario) throws ClassNotFoundException, SQLException {
        Connection con = null;
        PreparedStatement stmt = null;
        ...
        try {
            con = Conexion.getConnection();
            stmt = con.prepareStatement(SQL_DELETE_OBSERVACIONTEMPORALBYIDUSUARIO);
